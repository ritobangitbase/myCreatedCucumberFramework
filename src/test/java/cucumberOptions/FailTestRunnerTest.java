...
@CucumberOptions(
		//features="src/test/java/features/Login.feature",  //for specific feature file
				features="@target/failed_scenarios.txt",  //for all the feature files in a given package/folder. ideally this is used
				glue="stepDefinition", //path of package containing stepdefinition file 
				//tags="@RegTest", // for selective execution of specific tags
...
public class FailTestRunnerTest {
